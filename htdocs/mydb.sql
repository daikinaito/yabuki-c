...
-- Database: `yabukic`
--
DROP DATABASE IF EXISTS `yabukic`;
CREATE DATABASE IF NOT EXISTS `yabukic` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `yabukic`;
...
(1, '2018-07-20', 1, '12345678'),
(2, '2018-07-20', 5, '00000000');
